<template>
  <div class="side_nav_wrapper" :class="{ active: navIsActive }">
    ...
    <div class="side_nav_links_wrapper">
      ...
      <div class="home_route" @click="$emit('fireToggleNavDrawerEmit')" v-if="$can('categories index', 'categories')">
        <router-link to="/category/all">
          <span class="route_icon">
            <img src="@/assets/media/icons/ui_icons/store.svg" alt="icon" width="40" height="40" />
          </span>
          <span class="route_text">
            {{ $t("PLACEHOLDERS.app_sections") }}
          </span>
        </router-link>
      </div>
      ...
      <!-- Start:: regions Route -->
      <div class="home_route" @click="$emit('fireToggleNavDrawerEmit')" v-if="$can('regions index', 'regions')">
      ...
      <!-- Start:: faq Route -->
      <div class="home_route" @click="$emit('fireToggleNavDrawerEmit')" v-if="$can('questions index', 'questions')">
        <router-link to="/faq/all">
          <span class="route_icon">
            <img src="@/assets/media/icons/ui_icons/category.svg" alt="icon" width="40" height="40" />
          </span>
          <span class="route_text">
            {{ $t("PLACEHOLDERS.faq") }}
          </span>
