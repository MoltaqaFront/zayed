  ...
  <div class="show_all_content_wrapper">
    ...
    <main>
        ...
        <div class="filter_form_wrapper">
          <form @submit.prevent="submitFilterForm">
            <div class="row justify-content-center align-items-center w-100">
              ...
              <!-- Start:: Name Input -->
              <base-input col="6" type="text" :placeholder="$t('TABLES.Areas.name')" v-model.trim="filterOptions.title" />
              <!-- End:: Name Input -->

              <!-- <base-select-input col="6" v-if="getCountriesData" :optionsList="getCountriesData"
                :placeholder="$t('SIDENAV.Countries.title')" v-model="filterOptions.country_id" /> -->
      ...
      <div class="table_title_wrapper">
        ...
        <div class="title_route_wrapper" v-if="$can('regions create', 'regions')">
      ...
      <v-data-table class="thumb" :loading="loading" :loading-text="$t('TABLES.loadingData')" :search="searchValue"
        ...
        <template v-slot:[`item.is_active`]="{ item }">
          ...
          <div class="activation" dir="ltr" style="z-index: 1" v-if="$can('regions activate', 'regions')">
        ...
        <template v-slot:[`item.actions`]="{ item }">
          <div class="actions">
            ...
            <a-tooltip placement="bottom" v-if="$can('regions show', 'regions')">
              <template slot="title">
            ...
            <a-tooltip placement="bottom" v-if="$can('regions edit', 'regions')">
              <template slot="title">
            ...
            <a-tooltip placement="bottom" v-if="$can('regions delete', 'regions')">
              <template slot="title">
