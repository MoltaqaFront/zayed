  ...
  methods: {
    ...
    async resendVerificationCode() {
      ...
      try {
        ...
        localStorage.setItem("Zayed_provider_dashboard_verification_code", res.data.body.code);
    ...
    async submitForm() {
      ...
      const REQUEST_DATA = new FormData();
      // Start:: Append Request Data
      this.$axios.defaults.headers.common["Authorization"] = "Bearer " + localStorage.getItem("Zayed_provider_dashboard_forget_pass_token");
      REQUEST_DATA.append(
        "code",
        this.firstNumber +
        this.secondNumber +
      ...
      if (this.verificationType == "reset-password") {
        try {
          ...
          this.clearFormInputs();
          localStorage.removeItem("Zayed_provider_dashboard_email");
