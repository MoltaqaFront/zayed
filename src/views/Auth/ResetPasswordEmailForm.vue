  ...
  methods: {
    ...
    async submitForm() {
      ...
      try {
        ...
        localStorage.setItem("Zayed_provider_dashboard_verification_code", res.data.data.code);
        localStorage.setItem("Zayed_provider_dashboard_forget_pass_token", res.data.data.access_token);
